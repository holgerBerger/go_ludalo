...
func TestAlpsSimple1(t *testing.T) {
	...
	// try complete entry
	mongo.collection.Find(bson.M{"_id": "815842"}).One(&result)

	reference := Jobentry{"815842", "815842", "31251", 1470866890, 1470866959, "rule_the_world", "2133-2139,2141-2149,2200-2202,2215-2216,2287-2303,2436,2454-2480,2494,2496-2510,2562,2564,2566-2569,2574-2578,2590-2595,2597-2605,2665-2668,2670-2674,2680-2686,2692,3124-3132,3218-3245,3264-3266,4098-4099,4104-4107,4109-4110,4915-4917,4981,5371,5839,5843-5844,5905,5921,6136,6142-6143,6242,6256-6257,6265-6271,6276,6281-6283", -1}
	...
	mongo.collection.Find(bson.M{"_id": "815843"}).One(&result)

	reference = Jobentry{"815843", "815843", "", 1470866890, -1, "", "", -1}
